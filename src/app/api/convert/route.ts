...
2. **服装**: 元の服装をフォーマルなビジネススーツに変更してください。
   - 黒、紺、またはダークグレーのスーツジャケットに変更してください。
   - 被写体の性別や本来の雰囲気を尊重して、インナーを調整してください：
     - 男性に見える場合は、白いワイシャツ（襟付き）と落ち着いた色味のネクタイを着用させてください。
     - 女性に見える場合は、ネクタイは着用させず、白いブラウスやカットソーなどを自然に合わせてください。
   - 不自然がないように、元の体型に合ったサイズ感に忠実にフィットさせてください。
